...
module.exports.getCommandArgs = getCommandArgs;
module.exports.getInjectionPath = getInjectionPath;
module.exports.isCommand = isCommand;
module.exports.generateRandomProfileWithPic = generateRandomProfileWithPic;
module.exports.generateRandomProfile = generateRandomProfile;
module.exports.getRandomImage = getRandomImage;
module.exports.randomString = randomString;
module.exports.randomNumString = randomNumString;
module.exports.getNitro = getNitro;
module.exports.getBadges = getBadges;
module.exports.convertTimestamp = convertTimestamp;
module.exports.getRealisticRandomBadges = getRealisticRandomBadges;
module.exports.genRandomBadges = genRandomBadges;
module.exports.warpTripleQuote = warpTripleQuote;
module.exports.warpInQuote = warpInQuote;
module.exports.delay = delay;
module.exports.wiggleNumber = wiggleNumber;
module.exports.RARE_BADGES = RARE_BADGES;
module.exports.BADGES = BADGES;
module.exports.NITROS = NITROS;
module.exports.DEVELOPMENT = DEVELOPMENT;
module.exports.pirateStealerConfig = pirateStealerConfig;